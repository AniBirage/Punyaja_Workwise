...
export default function Compartment({ loading, data }) {
    ...
    return (
        <Box display={"flex"} justifyContent={"center"} flexDirection={"column"} h="full" gap="2" >
            ...
            <Flex gap="2" as="b" justify={"space-around"} color={"gray.700"}> <Text w="50%" textAlign={"center"} bg="#FFBF34" rounded={"lg"} p="2"> Booked Seats = {booked} </Text> <Text textAlign={"center"} w="50%" bg="#77AB59" rounded={"lg"} p="2"> Available Seats = {notBooked} </Text> </Flex>
        </Box>
    )
}
